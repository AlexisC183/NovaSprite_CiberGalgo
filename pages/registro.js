...
<Image
    ...
    <a style={{ position: "absolute", top: 170, right: 150, zIndex: 1 }}>
...
<a style={{ position: "absolute", top: 300, right: 220, zIndex: 1 }}>
    <div className="text-white font-bold"
>   PROFILE</div>
...
<a style={{ position: "absolute", top: 350, right: 150, zIndex: 1 }}>
    <div className="text-white font-bold"
>   Username:</div>
...
<a style={{ position: "absolute", top: 400, right: 150, zIndex: 1 }}>
    <div className="text-white font-bold"
>   Password:</div>
...
<a style={{ position: "absolute", top: 450, right: 150, zIndex: 1 }}>
    <div className="text-white font-bold"
...
<a style={{ position: "absolute", top: 550, right: 150, zIndex: 1 }} href="/demo">
    <div className="text-white font-bold"
>   Sign up</div>
</a>

<a style={{ position: "absolute", top: 550, right: 285, zIndex: 1 }} href="/">
    <div className="text-white font-bold"
>   Cancel</div>
</a>
